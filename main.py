...
for url in urls:
    try:
        ...
        audio["albumartist"] = author  # Album artist (for compilation use "Various Artists")
        ...
        if playlist_name:
            ...
            audio["tracknumber"] = f"{track_number}/{max_track_number}"  # Track number in album
        audio.save()

        print(f"Metadata set for: {yt.title}")
